    ...
    def Search(arg = None):
        if username_entry.get() == '': 
            ...
            if results:
                ...
                # Sizing Image
                canvas = Canvas(system1, width=500, height=350)
                
                # Opening Image
                image = ImageTk.PhotoImage(Image.open('C:/Users/minhhoang/.spyder-py3/en_de image/ImCrypt/Image/s6.jpg'))
                ...
                with conn:
                    cursor = conn.cursor() 
                # Searching for users
                #find_key = ('SELECT Key FROM Users WHERE Username = ?')
                #cursor.execute(find_key,username[0])
                ...
                Encrypt = tk.Button(frame1, text = "Encrypt", width="10", bd = '3', command = encrypt, font = ('Times', 12, 'bold'), bg='#097eeb',relief='groove', justify = 'center', pady='5')
                Encrypt.pack()
                ...
                Decrypt = tk.Button(frame1, text = "Decrypt", width="10", bd = '3',  command = encrypt, font = ('Times', 12, 'bold'), bg='#4018f2',fg='white', relief='groove', justify = 'center', pady='5')
                Decrypt.pack()
